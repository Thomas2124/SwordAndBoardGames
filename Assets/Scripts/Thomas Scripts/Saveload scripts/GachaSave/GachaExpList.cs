...
public class GachaExpList
{
    ...
    public GachaExpList(GachaRolls expList)
    {
        ...
        golem_exp = expList.golem_exp + expData.golem_exp;
        catperson_exp = expList.catperson_exp + expData.catperson_exp;
        angel_exp = expList.angel_exp + expData.angel_exp;
        devil_exp = expList.devil_exp + expData.devil_exp;
        orge_exp = expList.orge_exp + expData.orge_exp;
        gargoyle_exp = expList.gargoyle_exp + expData.gargoyle_exp;
        garuda_exp = expList.garuda_exp + expData.garuda_exp;
